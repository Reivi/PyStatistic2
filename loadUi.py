...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Number_value = QtWidgets.QLineEdit(self.centralwidget)
        self.Number_value.setMaximumSize(QtCore.QSize(150, 16777215))
        self.Number_value.setObjectName("Number_value")
        self.horizontalLayout.addWidget(self.Number_value)
